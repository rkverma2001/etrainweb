...
const Unity = () => {
  ...
  const features = [
    ...
    "Earn globally recognized certifications from Unity Certified User.",
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            ...
            <div className="w-full md:w-1/2">
              <img
                src="https://etrain.blr1.cdn.digitaloceanspaces.com/Logos/Unity.svg"
                className="mb-4 sm:mb-5 h-12 sm:h-14 md:h-16 object-contain"
                alt="Unity Category Logo"
              />
              <div className="text-gray-700 text-sm sm:text-base leading-relaxed text-justify">
                <p>
                  The Unity Certified User certification enables individuals to
                get started in interactive content creation for industries such
                as gaming, entertainment, automotive, XR, and AEC (architecture,
                engineering, and construction).
                </p>
                <p className="mt-3 sm:mt-4">
                  EtrainIndia provides a full pathway solution that students can
                use to prepare for the Unity Certified User certifications. From
                tailored learning materials and practice tests to Unity
                Certified User endorsed certification exams, EtrainIndia
            ...
            <div className="w-full md:w-1/2">
              <div className="w-full aspect-video border-2 rounded-2xl overflow-hidden">
                <video
                  ...
                  muted
                  playsInline
                  src="https://etrain.blr1.cdn.digitaloceanspaces.com/videos/unity.mp4"
                />
              </div>
            </div>
          </div>
      ...
      <div className="mt-[25px]">
        <div className="w-48 animate-marquee whitespace-nowrap bg-white ">
          {logos.concat(logos).map((logo, index) => (
            <img
              key={index}
              src={`https://etrain.blr1.cdn.digitaloceanspaces.com/ProductImages/UnityBadges/${logo}`}
              alt={logo}
              className="h-28 mx-[88px] inline-block"
            />
          ))}
        </div>
      </div>
          ...
          <div className="shrink-0">
            ...
            {selected === "exam-vouchers" && (
              <>
                ...
                <p className="text-center text-sm sm:text-base mb-6 sm:mb-8">
                  Official digital exam codes to take your Unity Certified User
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">
              {courseData[selected]?.map((course, index) => (
                <CourseCard
                  key={index}
                  image={`https://etrain.blr1.cdn.digitaloceanspaces.com/ProductImages/Unity/${course.image}`}
                  title={course.title}
      ...
      <div>
        <div className="flex flex-col md:flex-row w-full h-auto md:h-[500px]">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center p-6">
            <img
              src="https://etrain.blr1.cdn.digitaloceanspaces.com/Certificate/VrDeveloperCertificate.svg"
              alt="Unity Certificate"
