...
const Cisco = () => {
  ...
  const features = [
    ...
    "Earn globally recognized certifications from Cisco.",
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            ...
            <div className="w-full md:w-1/2">
              <img
                ...
                className="mb-4 sm:mb-5 h-12 sm:h-14 md:h-16 object-contain md:ml-[-33px]"
                alt="Cisco Category Logo"
              />
            ...
            <div className="w-full md:w-1/2">
              <div className="w-full aspect-video border-2 rounded-2xl overflow-hidden">
                <video
                  ...
                  muted
                  playsInline
                  src="https://etrain.blr1.cdn.digitaloceanspaces.com/videos/cisco.mp4"
                />
              </div>
            </div>
          </div>
      ...
      <div className="mt-[25px]">
        <div className="w-48 animate-marquee whitespace-nowrap bg-white ">
          {logos.concat(logos).map((logo, index) => (
            <img
              key={index}
              src={`https://etrain.blr1.cdn.digitaloceanspaces.com/ProductImages/CiscoBadges/${logo}`}
              alt={logo}
              className="h-28 mx-[58px] inline-block"
            />
          ))}
        </div>
      </div>
      ...
      <div>
        <div className="flex flex-col md:flex-row w-full h-auto md:h-[500px]">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center p-6">
            <img
              src="https://etrain.blr1.cdn.digitaloceanspaces.com/Certificate/CiscoCybersecurityCertificate.svg"
