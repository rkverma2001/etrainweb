...
const ItSpecialist = () => {
  ...
  const features = [
    ...
    "Earn globally recognized certifications from IT Specialist Certification.",
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            ...
            <div className="w-full md:w-1/2">
              <img
                src="https://etrain.blr1.cdn.digitaloceanspaces.com/Logos/ITSpecialist.svg"
                className="mb-4 sm:mb-5 h-12 sm:h-14 md:h-16 object-contain"
                alt="ItSpecialist Category Logo"
              />
              <div className="text-gray-700 text-sm sm:text-base leading-relaxed text-justify">
                ...
                candidates to validate foundational IT skills sought after by
                employers. The IT Specialist program is aimed at individuals who
                are considering or just beginning a path to a career in
                information technology.
                </p>
                <p className="mt-3 sm:mt-4">
                  EtrainIndia provides a full pathway solution that students can
                use to prepare for the Information Technology Specialist
                certifications. From tailored learning materials and practice
                tests to Information Technology Specialist certifications
            ...
            <div className="w-full md:w-1/2">
              <div className="w-full aspect-video border-2 rounded-2xl overflow-hidden">
                <video
                  ...
                  muted
                  playsInline
                  src="https://etrain.blr1.cdn.digitaloceanspaces.com/videos/itspecialist.mp4"
                />
              </div>
            </div>
          </div>
      ...
      <div className="mt-[27px]">
        <div className="w-48 animate-marquee whitespace-nowrap bg-white ">
          {logos.concat(logos).map((logo, index) => (
            <img
              key={index}
              src={`https://etrain.blr1.cdn.digitaloceanspaces.com/ProductImages/ItSpecialistBadges/${logo}`}
              alt={logo}
              className="h-28 mx-[18px] inline-block"
            />
          ))}
        </div>
      </div>
          ...
          <div className="shrink-0">
            {selected === "bundle" && (
              <>
                <h1 className="text-xl sm:text-2xl text-center mb-2 font-semibold flex items-center justify-center gap-2 flex-wrap">
                  <img
                    src="https://etrain.blr1.cdn.digitaloceanspaces.com/Logos/ITSpecialist.svg"
                    alt="ItSpecialist Logo"
                    className="h-15 sm:h-12 md:h-18 object-contain"
                  />
                </h1>
            ...
            {selected === "exam-vouchers" && (
              <>
                ...
                <p className="text-center text-sm sm:text-base mb-6 sm:mb-8">
                  Official digital exam codes to take your IT Specialist
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">
              {courseData[selected]?.map((course, index) => (
                <CourseCard
                  key={index}
                  image={`https://etrain.blr1.cdn.digitaloceanspaces.com/ProductImages/ItSpecialist${course.image}`}
                  title={course.title}
      ...
      <div>
        <div className="flex flex-col md:flex-row w-full h-auto md:h-[500px]">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center p-6">
            <img
              src="https://etrain.blr1.cdn.digitaloceanspaces.com/Certificate/AiCertificate.svg"
              alt="ItSpecialist Certificate"
