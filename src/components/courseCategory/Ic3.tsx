...
const Ic3 = () => {
  ...
  const logos = ["1.svg", "2.svg", "3.svg", "4.svg"];
  ...
  const features = [
    ...
    "Earn globally recognized certifications from IC3 Digital Literacy.",
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            ...
            <div className="w-full md:w-1/2">
              <img
                src="https://etrain.blr1.cdn.digitaloceanspaces.com/Logos/IC3.svg"
                className="mb-4 sm:mb-5 h-12 sm:h-14 md:h-16 object-contain"
                alt="IC3 Category Logo"
              />
              <div className="text-gray-700 text-sm sm:text-base leading-relaxed text-justify">
                <p>
                  The IC3 Digital Literacy Certification is a globally recognized
                credential that validates essential digital skills needed in
                today’s technology-driven world. It provides a strong foundation
                for students and professionals by demonstrating their
                proficiency in key areas such as computing fundamentals, key
                applications, and living online.
                </p>
                <p className="mt-3 sm:mt-4">
                  EtrainIndia provides a full pathway solution that students can
                use to prepare for the IC3 Digital Literacy
                certifications. From tailored learning materials and practice
                tests to IC3 Digital Literacy certifications
            ...
            <div className="w-full md:w-1/2">
              <div className="w-full aspect-video border-2 rounded-2xl overflow-hidden">
                <video
                  ...
                  muted
                  playsInline
                  src="https://etrain.blr1.cdn.digitaloceanspaces.com/videos/ic3.mp4"
                />
              </div>
            </div>
          </div>
      ...
      <div className="mt-[25px]">
        <div className="w-48 animate-marquee whitespace-nowrap bg-white ">
          {logos.concat(logos).map((logo, index) => (
            <img
              key={index}
              src={`https://etrain.blr1.cdn.digitaloceanspaces.com/ProductImages/ic3Badges/${logo}`}
              alt={logo}
              className="h-26 mx-[78px] inline-block"
            />
          ))}
        </div>
      </div>
          ...
          <div className="shrink-0">
                ...
                <>
                  <h1 className="text-xl sm:text-2xl text-center mb-2 font-semibold flex items-center justify-center gap-2 flex-wrap">
                    <img
                      ...
                      className="h-15 sm:h-12 md:h-20 object-contain"
                    />
                  </h1>
            ...
            {selected === "exam-vouchers" && (
                <>
                  ...
                  <p className="text-center text-sm sm:text-base mb-6 sm:mb-8">
                    Official digital exam codes to take your IC3 Digital Literacy certification exam online with remote
                  proctoring.
                  </p>
                </>
              )}
            ...
            <div className="flex-1 lg:max-h-[70vh] overflow-y-auto pr-1 sm:pr-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">
                {courseData[selected]?.map((course, index) => (
                  <CourseCard
                    key={index}
                    image={`https://etrain.blr1.cdn.digitaloceanspaces.com/ProductImages/Ic3${course.image}`}
                    title={course.title}
      ...
      <div>
        <div className="flex flex-col md:flex-row w-full h-auto md:h-[500px]">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center p-6">
            <img
              src="https://etrain.blr1.cdn.digitaloceanspaces.com/Certificate/Ic3GsCertificate.svg"
              alt="IC3 Digital Literacy Certificate"
