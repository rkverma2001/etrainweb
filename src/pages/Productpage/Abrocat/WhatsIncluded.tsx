  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="flex items-center justify-center mt-10">
        {activeTab === "Bundle" && (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 place-items-center w-full px-4 sm:px-6 md:px-0">
            {/* CARD 1 */}
            <Card className="relative w-full max-w-xl p-4 sm:p-5 transition-all duration-300 ease-in-out hover:scale-105 shadow-[0_0_10px_rgba(0,0,0,0.2)]">
              {/* Info Button */}
              <button
                type="button"
              ...
              {showInfo && (
                <div className="absolute top-10 right-2 z-50 w-64 sm:w-72 bg-white border border-gray-200 rounded-lg shadow-xl p-4">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                    A self-paced e-learning course that allows you to learn
                    anytime, anywhere, at your own convenience. Access engaging
                    video-based training, interactive learning content,
                    structured lessons, and hands-on activities designed to help
                    you build practical, industry-relevant skills.
                  </p>
                </div>
              )}
